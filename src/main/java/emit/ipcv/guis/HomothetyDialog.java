 ...
 * @author rinelfi
 */
public class HomothetyDialog extends javax.swing.JDialog implements ObservableClass<float[]> {
   ...
   * @param modal
   */
  public HomothetyDialog(java.awt.Frame parent, boolean modal) {
    super(parent, modal);
    initComponents();
    observers = new ArrayList<>();
  }

  public HomothetyDialog setTranslation(TranslationDao translation) {
    this.translation = translation;
    return this;
  }

  public HomothetyDialog setLanguage(DBLanguage language) {
    this.language = language;
    return this;
  }

  public HomothetyDialog initLanguage() {
    setTitle(translation.get(language, "homothety").toString());
