 ...
 * @author rinelfi
 */
public class ThresholdingDialog extends javax.swing.JDialog implements ObservableClass<Integer> {
   ...
   * @param modal
   */
  public ThresholdingDialog(java.awt.Frame parent, boolean modal) {
    super(parent, modal);
    initComponents();
    observers = new ArrayList<>();
  }
  
  public ThresholdingDialog setTranslation(TranslationDao translation) {
    this.translation = translation;
    return this;
  }
  
  public ThresholdingDialog setLanguage(DBLanguage language) {
    this.language = language;
    return this;
  }
  
  public ThresholdingDialog initLanguage() {
   setTitle(translation.get(language, "thresholding").toString());
    rotationAngleLab.setText(translation.get(language, "threshold").toString() + ":");
  ...
  private void initComponents() {
    ...
    thresholdSpin = new javax.swing.JSpinner();
    ...
    rotationAngleLab.setText("Seuil:");
    ...
    gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
    gridBagConstraints.insets = new java.awt.Insets(6, 6, 6, 6);
    rootPanel.add(thresholdSpin, gridBagConstraints);
  ...
  private void confirmButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmButtonActionPerformed
    dispose();
    update(Integer.valueOf(thresholdSpin.getValue().toString()));
  ...
  private javax.swing.JSpinner thresholdSpin;
