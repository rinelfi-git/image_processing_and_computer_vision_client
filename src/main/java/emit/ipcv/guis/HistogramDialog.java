...
public class HistogramDialog extends javax.swing.JDialog {
   ...
   */
  public HistogramDialog(java.awt.Frame parent, boolean modal) {
    super(parent, modal);
    initComponents();
    minIndex = 0;
    maxIndex = 19;
  ...
  public HistogramDialog setTranslation(TranslationDao translation) {
    this.translation = translation;
    return this;
  }
  
  public HistogramDialog setLanguage(DBLanguage language) {
  ...
  public void loadPartialChart() {
    ...
    chart = new CategoryChartBuilder().title(translation.get(language, "histogram").toString()).xAxisTitle("Occurence").yAxisTitle(translation.get(language, "color").toString()).build();
  ...
  public void loadFullChart() {
    ...
    fullChart.getStyler().setDefaultSeriesRenderStyle(XYSeries.XYSeriesRenderStyle.Step);
